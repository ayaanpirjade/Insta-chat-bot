...
def main_menu():
    lines = [
        ...
        make_header("💬 AI CHAT"),
        divider(),
        make_line(f"!ai question  ", "🤖 ChatGPT"),
        make_line(f"!summarize  ", "📝 Summarize"),
        make_line(f"!translate  ", "🌐 Translate"),
        make_line(f"!rewrite  ", "✍️ Rewrite"),
        make_line(f"!caption  ", "📸 Caption"),
        make_line(f"!explain  ", "💡 Explain"),
        make_line(f"!resetai  ", "🧹 Reset memory"),
        make_line(f"@{U[:10]}  ", "🤖 Group chat"),
        bottom_box(),
        "",
    ]
    return "\n".join(lines)
...
def music_menu():
    lines = [
        ...
        make_line("!dvn  ", "🎤 Save VN"),
        make_line("!pvn  ", "🔊 Play VN"),
        divider(),
        make_header("💡 Usage"),
        make_line("!dvn name  ", "(reply)"),
        make_line("!pvn name  ", "(play)"),
        make_line("!vn song  ", ""),
        make_line("!play song  ", ""),
        bottom_box(),
        "",
...
def bot_info():
    ...
    return "\n".join([
        ...
        make_line("AI  ", "Configurable providers"),
